...
jumango_ai_collection = client.get_or_create_collection("jumango_ai", embedding_function=openai_ef)
...
def recall(query: str, n: int):
    ...
    results = jumango_ai_collection.query(
        query_texts=[query],
        n_results=n
    )
